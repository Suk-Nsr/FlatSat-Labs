...
// Lab 3.3: Mission Logic & Camera Control
...
#include "src/Lab3_TB_Mission_Logic.h"
...
void setup() {
  ...
  Serial.println("Lab 3.3: Mission Logic Started");
...
void loop() {
  ...
  if (millis() - lastMissionRun > 5000) {
    ...
    // TODO 2: Write your GPS-Gating logic here (same as Lab 3.2)
    // [Add your code here]
